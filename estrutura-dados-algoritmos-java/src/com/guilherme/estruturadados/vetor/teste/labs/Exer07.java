...
public class Exer07 extends Exer06 {
    ...
    private static void adicionaContatoFinal(Scanner scan, ArrayList<Contato> lista) {
    ...
    private static void adicionaContatoPosicao(Scanner scan, ArrayList<Contato> lista) {
